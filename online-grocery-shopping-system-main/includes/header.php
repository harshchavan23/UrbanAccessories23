...
<div id="page-container">
    <header class="py-3" style="background-color: #ff8ed0;">
        <div class="container gap-3">
            <div class="d-flex align-items-center flex-wrap flex-sm-nowrap justify-content-between">
                ...
                <a href="index.php?id=<?=$userid; ?>" class="navbar-brand order-2">
                    <img src="../img/logomain.png" alt="logo" width="150" class="mx-2">
                </a>
            <?php 
            } else {
    ...
    <nav  class="navbar navbar-expand-sm stickyjimmy shadow py-2 justify-content-center" style="background-color: #81ecff;">
            ...
            <div class="container">
                ...
                <?php 
                    if(isset($_SESSION['success'])){
                        $userid = $_SESSION['user'];
                        echo "
                            <li class='nav-item'><a href='../src/products.php?page=1&id=$userid&p_cat_id=1' class='nav-link text-dark'>AUDIO</a></li>
                            <li class='nav-item'><a href='../src/products.php?page=1&id=$userid&p_cat_id=2' class='nav-link text-dark'>COVERS</a></li>
                            <li class='nav-item'><a href='../src/products.php?page=1&id=$userid&p_cat_id=3' class='nav-link text-dark'>SMARTDEVICE</a></li>
                            <li class='nav-item'><a href='../src/products.php?page=1&id=$userid&p_cat_id=4' class='nav-link text-dark'>CHARGER/CABLES</a></li>
                            <li class='nav-item'><a href='../src/products.php?page=1&id=$userid&p_cat_id=5' class='nav-link text-dark'>GAMING</a></li>
                        "
                        ;
                    }
                    else{
                        echo "
                        <li class='nav-item'><a href='../src/products.php?p_cat_id=1' class='nav-link text-dark'>AUDIO</a></li>
                        <li class='nav-item'><a href='../src/products.php?p_cat_id=2' class='nav-link text-dark'>COVERS</a></li>
                        <li class='nav-item'><a href='../src/products.php?p_cat_id=3' class='nav-link text-dark'>SMARTDEVICE</a></li>
                        <li class='nav-item'><a href='../src/products.php?p_cat_id=4' class='nav-link text-dark'>CHARGER/CABLES </a></li>
                        <li class='nav-item'><a href='../src/products.php?p_cat_id=5' class='nav-link text-dark'>GAMING</a></li>
                        "
                    ;
                    }
                ?>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered signin_dialog">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #ffa3ca;">
