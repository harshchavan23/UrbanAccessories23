        ...
        <div class="row my-4">
            <div class="col-sm-12 col-lg-8 rounded-3 bg-white mx-auto my-1">
                ...
                <div class="row py-xxl-3 py-sm-4 align-items-center" style="border-bottom: 1px #c7c7c7 solid;">
                    ...
                    <div class="col align-self-center">
                        <div>
                            <h4><?=$product_name?></h4>
                            <p class="text-success fw-bold" id="singlePrice<?=$cartID?>">RS <?=$product_price?></p>
                        </div>
                    </div>
                    <div class="col-2">
                    ...
                    <div class="col-2 align-self-center">
                        ...
                        <script>
                            ...
                            <p id="total<?=$cartID?>" class="text-center text-success fw-bold">RS <?php echo $phpvar ?></p>
                        </div>
                    </div>
                ...
                function cartTotalCal<?=$cartID?>(){
                    ...
                    // document.getElementById("total<?=$cartID?>").innerHTML = "RS " + total.toFixed(2);
                    ...
                    //         var minus = sum[0].innerText.replace("RS ", "") - quantity[0].value * parseFloat(price[0].innerText.replace("RS ", ""));
                    //         console.log(sum[0].innerText.replace("RS ", ""));
                    //         document.getElementById("cartTotal").innerHTML = "RS " + minus.toFixed(2);
                    //     };
                    // }
                    $.ajax({
                        type:"post",
                ...
                function cartTotalCal1<?=$cartID?>(){
                    ...
                    for (let index = 0; index < itemBox.length; index++) {
                        if (itemBox[index].checked == true) {
                            total1 += parseFloat(price[index].innerText.replace("RS ", ""));
                            document.getElementById("cartTotal").innerHTML = "RS " + total1.toFixed(2);
                        }else{
                            total1 = total1 - parseFloat(price[index].innerText.replace("RS ", ""));                          
                        };
            ...
            <div class="col-sm-12 col-lg-auto rounded-3 mx-auto my-1 bg-success align-self-start sticky-xl-topList">
                ...
                <div class="row text-white align-items-center py-3">
                    ...
                    <div class="col-sm-12 mx-auto">
                        <h1 class="text-center" id="cartTotal">RS 0.00</h1>
                    </div>
                </div>
