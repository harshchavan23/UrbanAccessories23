...
?>
    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade carousel-dark slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" style="height:fit-content;">
            <div class="carousel-item active">
                <img src="../img/new carsouel1.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="../img/newcarousel2.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="../img/newcarousel3.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="../img/newcarousel4.png" class="d-block w-100" alt="...">
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="text-center">
            <div class="row">
                <div class="col-md" style="background-color: #3b5998; padding: 1rem;">
                    ...
                    <h1>TECH MANIA SALE!</h1>
                    <h5>Get up to 25% off</h5>
                </div>
                <div class="col-md" style="background-color: #cc5e50; padding: 1rem;">
                    ...
                    <h1>FREE SHIPPING </h1>
                    <h5>On orders over RS 350.00</h5>
                </div>
                <div class="col-md" style="background-color: #a78c3d; padding: 1rem;">
                    ...
                    <h1>20% OFF</h1>
                    <h5>When you use HDFC credit card</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="cardIndex">
        <div class="container">
            <div class="d-flex flex-row align-items-center py-3  gap-3">
                <h2 class="mt-1">VIDYALANKAR CPE SALE</h2>
